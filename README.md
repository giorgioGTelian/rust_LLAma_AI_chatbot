...
## Acknowledgements
made by GPT-3, LLaMA, etc. and the Rust community for their amazing work on the Rust language and ecosystem.
love to the TailwindCSS team for making it so easy to make a beautiful webapp with minimal effort.
Giorgio Tassinari